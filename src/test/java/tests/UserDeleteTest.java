...
public class UserDeleteTest extends BaseTestCase {
    ...
    public void testDeleteUserWithIdTwo(){
        ...
        Response responseGetAuth = apiCoreRequests.userLogin("https://playground.learnqa.ru/api/user/login", authData);

        Response responseDeleteUser = apiCoreRequests.deleteUser("https://playground.learnqa.ru/api/user/2",
    ...
    public void testDeleteCreatedUser(){
        ...
        Response responseCreateAuth = apiCoreRequests.createUserRequest("https://playground.learnqa.ru/api/user",userData);
        ...
        //DELETE
        Response responseDeleteUser = apiCoreRequests.deleteUser("https://playground.learnqa.ru/api/user/"+userId,
                this.getHeader(responseGetAuth, "x-csrf-token"),
                this.getCookie(responseGetAuth, "auth_sid"));
        ...
        Response responseUserData = apiCoreRequests.getUserData("https://playground.learnqa.ru/api/user/"+userId,
                this.getHeader(responseGetAuth, "x-csrf-token"),
                this.getCookie(responseGetAuth, "auth_sid"));
    ...
    public void testDeleteUserAnotherLoginUser (){
        ...
        Response responseCreateUser1 = apiCoreRequests.createUserRequest("https://playground.learnqa.ru/api/user",userLoginData);
        ...
        Response responseCreateUser2 = apiCoreRequests.createUserRequest("https://playground.learnqa.ru/api/user",userEditData);
        ...
        Response responseEditUser = apiCoreRequests.deleteUser("https://playground.learnqa.ru/api/user/"+userId,
                this.getHeader(responseGetAuth , "x-csrf-token"),
                this.getCookie(responseGetAuth, "auth_sid"));
